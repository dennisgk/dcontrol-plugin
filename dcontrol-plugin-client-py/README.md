...
Incoming requests are dispatched as background tasks. Set `max_concurrent_commands` in `config.json` to a positive number to cap simultaneous commands, or set it to `0` for no limit.
